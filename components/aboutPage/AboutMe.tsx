...
export default function AboutMe() {
  ...
  return (
    <div className="px-12 py-10">
      <article className="prose max-w-none prose-h2:mb-2.5 prose-h2:text-[1.6rem] prose-p:text-2xl prose-p:leading-[1.65] text-justify">
      ...
      <ul className="grid grid-cols-1 mt-6 location sm:grid-cols-2 gap-y-2">
        ...
        <MyInfo field="residence" value="Algeria" />
