export const Bio = {
  name: "Harizi",
  roles: ["DevOps Engineer", "Cloud Infrastructure Specialist", "Automation Engineer"],
  description:
  ...
  facebook: "https://www.facebook.com/abd0hrz/",
};
...
export const projects = [
  ...
  },
  {
    ...
    description:
      "Saniiro helps you to keep your business one step ahead in the race! It is a full-stack web application made with React Js, Material UI, Node Js, Express Js, and MongoDB. It has features like user authentication, user authorization, and user roles. It has a responsive user interface that provides users with a seamless experience across all devices.",
    image:
  ...
  },
  {
    ...
    description:
      "Privily is a web application that allows users to book pods for their personal use. It is a full-stack web application made with React Js, Material UI, Node Js, Express Js, and MongoDB. It has features like user authentication, user authorization, and user roles. It has a responsive user interface that provides users with a seamless experience across all devices.",
    image:
  ...
  },
  {
    ...
    description:
      "Movix is a web application that allows users to search for movies and TV shows. It is a full-stack web application made with React Js, Redux, and the TMDB API.  It has a responsive user interface that provides users with a seamless experience across all devices.",
    image:
  ...
  },
  {
    ...
    date: "Jun 2023",
    description:
      "A web app that connects people who need help with people who can help. It has features like user authentication, user authorization, and user roles. It has a responsive user interface that provides users with a seamless experience across all devices.",
    image:
